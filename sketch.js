...
function setup () {
  ...
  var color3 = color(150, 175, 150);
  var color4 = color(200, 200, 250);


  var flowerOne = new PlainFlower(width/2 - 40, 3 * height/4, color1);
  var flowerTwo = new PlainFlower(width/2 + 40, 3 * height/4, color2);
   var flowerThree = new FancyFlower(width/2 - 20, 3 * height/5, color3);
  var flowerFour = new FancyFlower(width/2 + 20, 3 * height/5, color4);
...
class FancyFlower {
  constructor(x, y, color) {
    ...
    this.bloomSpeed = random(0, 2);
    this.maxBloomSize = random(25, 100);
  }
  ...
  drawBloom() {
    ...
    rect(this.x - 30, this.y - this.size, this.bloomSize, this.bloomSize)
}
}
